...
const DEMO_TEMPLATE = `<av-tabs class="w-full max-w-lg" variant="secondary" orientation="vertical" default-selected-key="account">
...
export const DEMO_NAME = 'tabs-secondary-vertical';
...
export class TabsSecondaryVerticalDemo {}`;
