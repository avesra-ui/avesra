...
const DEMO_TEMPLATE = `<av-tabs class="w-full max-w-md" variant="secondary" default-selected-key="overview">
...
export const DEMO_NAME = 'tabs-secondary';
...
export class TabsSecondaryDemo {}`;
