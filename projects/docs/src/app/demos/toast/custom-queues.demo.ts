...
const DEMO_TEMPLATE = `<div class="flex flex-wrap gap-3">
    ...
    <av-toast placement="bottom" key="queue-notifications" [max-visible-toasts]="2" />
    <av-toast placement="top" key="queue-errors" [max-visible-toasts]="3" />
    <av-toast placement="bottom-end" key="queue-success" [max-visible-toasts]="1" />
  `;

export const DEMO_NAME = 'toast-custom-queues';
