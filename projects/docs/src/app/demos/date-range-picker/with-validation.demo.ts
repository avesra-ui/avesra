...
export const DEMO_NAME = 'date-range-picker-with-validation';
...
@Component({
  selector: 'app-date-range-picker-with-validation-demo',
  imports: [
    AvDateRangePickerImports,
    AvLabelComponent,
    AvFieldErrorComponent,
...
export class DateRangePickerWithValidationDemo {
