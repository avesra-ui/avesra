...
const DEMO_TEMPLATE = `<div class="w-[250px] space-y-5 rounded-lg bg-surface p-4 shadow-surface">
...
export const DEMO_NAME = 'skeleton-card';
...
@Component({
  ...
  host: { class: 'block' },
  template: \`<div class="w-[250px] space-y-5 rounded-lg bg-surface p-4 shadow-surface">
      <div av-skeleton class="h-32 rounded-lg"></div>
      <div class="space-y-3">
        <div av-skeleton class="h-3 w-3/5 rounded-lg"></div>
        <div av-skeleton class="h-3 w-4/5 rounded-lg"></div>
