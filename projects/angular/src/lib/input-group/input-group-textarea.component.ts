...
@Component({
  ...
  selector: 'textarea[av-input-group-textarea]',
  template: '',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => AvInputGroupTextareaComponent),
      multi: true,
    },
  ],
})
export class AvInputGroupTextareaComponent implements ControlValueAccessor {
  ...
  /** Marks the textarea as invalid. Inherits from `av-input-group` when omitted. */
